  ...
  return (
      <Editor
        ...
        init={{
          ...
          menubar: false,
          plugins:
            'visualchars visualblocks table searchreplace preview pagebreak nonbreaking media lists advlist lists link insertdatetime image help fullscreen emoticons directionality code codesample charmap accordion anchor autolink autoresize autosave',
          toolbar: `
